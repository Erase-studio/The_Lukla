...
export default function Menu() {
  ...
  const art =
    plates.momo && plates.dosa ? (
      <div className="relative aspect-square w-full">
        <ScrollTurn degrees={-24} className="absolute right-[14%] top-0 aspect-square w-[72%]">
          <Image
            src={plates.momo.src}
            alt=""
            fill
        ...
        <ScrollTurn degrees={30} className="absolute bottom-[2%] left-0 aspect-square w-[54%]">
          <Image
            src={plates.dosa.src}
            alt=""
            fill
  ...
  return (
    <>
      ...
      >
        <a href={FULL_MENU_URL} target="_blank" rel="noopener noreferrer" className={darkPrimary}>
          Full menu (PDF)
