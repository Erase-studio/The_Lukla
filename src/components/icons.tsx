...
export function IconPhone(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path
        d="M6.6 10.8c1.4 2.8 3.8 5.2 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .5 1 1V20c0 .6-.4 1-1 1C10.8 21 3 13.2 3 3.6c0-.6.4-1 1-1h3.4c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.4 0 .8-.2 1L6.6 10.8Z"
        strokeLinecap="round"
...
export function IconFacebook(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M13.5 21v-7.6h2.6l.4-3h-3V8.4c0-.9.3-1.5 1.6-1.5h1.5V4.2C15.9 4.1 15 4 14 4c-2.4 0-4 1.5-4 4.1v2.3H7.4v3H10V21h3.5Z" />
    </svg>
  );
}
...
export function IconTwitter(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M20 6.4c-.6.3-1.3.5-2 .6a3.5 3.5 0 0 0 1.5-1.9c-.7.4-1.4.7-2.2.9a3.4 3.4 0 0 0-5.9 3.1A9.7 9.7 0 0 1 4.3 5.6a3.4 3.4 0 0 0 1.1 4.6c-.6 0-1.1-.2-1.6-.4v.1c0 1.7 1.2 3 2.8 3.4-.5.1-1 .2-1.5.1.4 1.4 1.7 2.4 3.2 2.4A6.9 6.9 0 0 1 3 17.2a9.7 9.7 0 0 0 5.3 1.6c6.3 0 9.8-5.3 9.8-9.8v-.4c.7-.5 1.3-1.1 1.9-1.8Z" />
    </svg>
  );
}
...
export function IconTiktok(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M14.5 3h2.1c.1 1.2.6 2.2 1.5 3 .8.7 1.8 1.1 2.9 1.2v2.2c-1.5 0-2.9-.4-4.1-1.2v6.1c0 3-2.4 5.4-5.5 5.4-3 0-5.5-2.4-5.5-5.4S8.4 9 11.4 9c.3 0 .6 0 .9.1v2.2c-.3-.1-.6-.1-.9-.1a3.2 3.2 0 1 0 0 6.4c1.8 0 3.2-1.4 3.2-3.2V3Z" />
    </svg>
  );
}
...
export function IconWhatsapp(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M12 2.5A9.3 9.3 0 0 0 3.8 16.8L2.5 21.5l4.8-1.3A9.3 9.3 0 1 0 12 2.5Zm0 1.8a7.5 7.5 0 0 1 6.5 11.2 7.4 7.4 0 0 1-8.1 3.4l-.4-.1-2.8.8.8-2.7-.1-.3A7.5 7.5 0 0 1 12 4.3Zm-3 3.6c-.2 0-.5.1-.7.4-.2.2-.9.9-.9 2.2s.9 2.5 1.1 2.7c.1.2 1.8 2.9 4.5 3.9 2.2.9 2.7.7 3.2.6.5 0 1.6-.6 1.8-1.2.2-.6.2-1.1.2-1.2-.1-.1-.3-.2-.5-.3l-2.1-1c-.2-.1-.4-.1-.6.1l-.8 1c-.1.2-.3.2-.5.1-.7-.3-1.5-.8-2.2-1.5-.6-.6-1.1-1.3-1.4-2-.1-.2 0-.4.1-.5l.5-.6c.1-.2.2-.4.1-.6L9.5 8.2c-.1-.3-.3-.3-.5-.3Z" />
    </svg>
  );
}
...
// Google's "G" mark, shown only to attribute reviews and the rating to Google.
