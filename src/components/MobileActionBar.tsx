...
// Phones only: once the hero is behind you, the two things people come for stay one tap away.
...
export function MobileActionBar() {
  ...
  useEffect(() => {
    ...
    const sync = () => setVisible(pastHero && !footerInView);
  ...
  return (
    ...
    >
      ...
      >
        <a href="#menu" className="btn btn-line flex-1 justify-center bg-paper">
          Menu
        </a>
